...
public final class RbenvUtils {
    ...
    public static String buildRbenvRubiesPath( String userRbenvInstallPath ) {
        ...
        return userRbenvInstallPath + File.separator + RBENV_VERSIONS_FOLDER_NAME;
    }
    ...
    public static RubyRuntimeName parseRubyRuntimeName( final String rubyRuntimeName ) {
        ...
        Preconditions.checkArgument(
                tokens.getGemSet().equals( RubyRuntimeName.DEFAULT_GEMSET_NAME ),
                "Bad gem set, expected only default gemset for rbenv runtimes." );
    ...
    public static String buildRbenvRubyBinPath( String userRbenvInstallPath, String rubyName, String commandName ) {
        ...
        return userRbenvInstallPath + File.separator + RBENV_VERSIONS_FOLDER_NAME + File.separator + rubyName + BIN_FOLDER_RELATIVE_PATH
                + File.separator + commandName;
    }
