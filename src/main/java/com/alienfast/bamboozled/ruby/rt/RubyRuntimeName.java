...
public class RubyRuntimeName {
    ...
    public static RubyRuntimeName parseString( String rubyRuntimeName ) {
        ...
        if ( stringTokenizer.countTokens() == 2 ) {
            ...
            throw new IllegalArgumentException( "Could not parse rubyRuntime string, expected something like ruby-1.9.2-p123@default, not "
                    + rubyRuntimeName );
        }
    ...
    public String toString() {
        ...
        return new ToStringBuilder( this ).append( "version", this.version ).append( "gemSet", this.gemSet ).toString();
    }
}
