...
public class WindowsRubyLocator extends BaseRubyLocator implements RubyLocator {
    ...
    private static final List<String> filterList = ImmutableList.of(
            EnvUtils.MY_RUBY_HOME,
            EnvUtils.GEM_HOME,
            EnvUtils.GEM_PATH,
            EnvUtils.BUNDLE_HOME );
    ...
    public String detectExecutableOnPath( String executableName ) {
        ...
        try {
            ...
            final String executablePathOutput = this.execHelper.getExecutablePath( executableName, true );
