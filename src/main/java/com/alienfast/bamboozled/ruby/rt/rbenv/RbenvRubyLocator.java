...
public class RbenvRubyLocator extends BaseRubyLocator implements RubyLocator {
    ...
    public RubyRuntime getRubyRuntime( String rubyName, String gemSetName ) {
        ...
        final String rubyExecutablePath = RbenvUtils.buildRubyExecutablePath( this.userRbenvInstallPath, rubyName );
        this.fileSystemHelper.assertPathExists( rubyExecutablePath, "Unable to location ruby executable for " + rubyName );
    ...
    public List<RubyRuntime> listRubyRuntimes() {
        ...
        List<String> rubiesList = this.fileSystemHelper.listPathDirNames( RbenvUtils.buildRbenvRubiesPath( this.userRbenvInstallPath ) );
    ...
    public boolean hasRuby( String rubyRuntimeName ) {
        ...
        return this.fileSystemHelper.pathExists( rubyExecutablePath );
    }
