...
import com.alienfast.bamboozled.ruby.rt.system.SystemRubyUtils;
...
public class SystemRubyUtilsTest {
    ...
    static final String rubyOsxVersionString = "ruby 1.8.7 (2010-01-10 patchlevel 249) [universal-darwin11.0]";

    static final String rubyLinuxVersionString = "ruby 2.0.0p0 (2013-02-24 revision 39474) [x86_64-linux]";
