package com.alienfast.bamboozled.ruby.fixtures;

import java.io.File;

import com.alienfast.bamboozled.ruby.rt.RubyRuntime;
import com.alienfast.bamboozled.ruby.rt.rvm.RvmInstallation;
import com.alienfast.bamboozled.ruby.rt.rvm.RvmRubyRuntimeLocatorService.Constants;
...
public final class RvmFixtures {
    ...
    public static RubyRuntime getJRubyRuntimeDefaultGemSet() {
        ...
        return new RubyRuntime( "jruby-1.6.5", "default", USER_HOME + "/.rvm/rubies/jruby-1.6.5/bin/jruby", USER_HOME
                + "/.rvm/gems/jruby-1.6.5" );
    }

    public static RubyRuntime getMRIRubyRuntimeDefaultGemSet() {

        return new RubyRuntime( "ruby-1.9.3-p0", "default", USER_HOME + "/.rvm/rubies/ruby-1.9.3-p0/bin/ruby", USER_HOME
                + "/.rvm/gems/ruby-1.9.3-p0" );
    }

    public static RubyRuntime getMRIRubyRuntimeRails31GemSet() {

        return new RubyRuntime( "ruby-1.9.3-p0", "rails31", USER_HOME + "/.rvm/rubies/ruby-1.9.3-p0/bin/ruby", USER_HOME
                + "/.rvm/gems/ruby-1.9.3-p0@rails31" );
    }

    public static String getMRIRubyRuntimeDefaultBinPath() {

        return USER_HOME + "/.rvm/gems/ruby-1.9.3-p0/bin" + ":" + USER_HOME + "/.rvm/gems/ruby-1.9.3-p0@global/bin" + ":" + USER_HOME
                + "/.rvm/rubies/ruby-1.9.3-p0/bin" + ":" + TEST_CURRENT_PATH;
    }
